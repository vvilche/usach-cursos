...
CLASES.append(dict(curso=IN, n=1, fecha="Sáb 26 sep 2026", titulo="¿Qué es innovar de verdad? Disrupción vs mejora",
  ...
  slides=[
   ...
   ("pasos", dict(kicker="La tarea", h2="Encontrá el «job»", steps=[("Elegí un mercado real.",""),("Describí el trabajo","que hoy se resuelve mal (funcional + emocional + social)."),("NO propongas solución todavía","— solo el problema.")])),
...
CLASES.append(dict(curso=IN, n=2, fecha="Sáb 03 oct 2026", titulo="Océano Azul: crear mercados sin competencia",
  ...
  slides=[
   ("pregunta", dict(kicker="La pregunta", h2="¿Competir por lo mismo o crear mercado nuevo?", big="En el <b>océano rojo</b> todos pelean por los mismos clientes y el agua se tiñe de sangre. En el <b>océano azul</b> redefinís el juego y la competencia se vuelve irrelevante.")),
   ("vs", dict(kicker="La distinción", h2="Rojo vs. azul", bad_t="Océano rojo", bad=["Competís en un mercado saturado","Ganás quitándole clientes al otro","Márgenes que se achican"], good_t="Océano azul", good=["Creás demanda nueva","La competencia deja de importar","Márgenes altos al inicio"])),
   ("definicion", dict(kicker="La herramienta", h2="La curva de valor (strategy canvas)", defn="Un gráfico que compara <b>en qué factores compite</b> la industria. Innovar es <b>cambiar la forma</b> de esa curva, no moverla un poco.", meta="Si tu curva es una copia desplazada de la competencia, seguís en océano rojo.")),
...
CLASES.append(dict(curso=IN, n=3, fecha="Sáb 10 oct 2026", titulo="Modelo de negocio: Canvas + 4 cajas",
  ...
  slides=[
   ...
   ("lista", dict(kicker="Complemento", h2="4 cajas de Johnson", items=["<b>Propuesta de valor</b> para el cliente.","<b>Fórmula de utilidad:</b> cómo generás margen (ingresos - costos).","<b>Recursos clave.</b>","<b>Procesos clave.</b>"])),
...
CLASES.append(dict(curso=IN, n=4, fecha="Sáb 17 oct 2026", titulo="Patrones: 55 patrones + 10 tipos de innovación",
  ...
  slides=[
   ...
   ("lista", dict(kicker="Patrones clave", h2="6 patrones con ejemplo", items=["<b>Freemium:</b> Spotify, LinkedIn.","<b>Suscripción:</b> Netflix, SaaS.","<b>Razor-and-blade:</b> la máquina barata, el repuesto caro (Gillette).","<b>Marketplace:</b> conectás oferta y demanda (MercadoLibre, Airbnb).","<b>Long tail:</b> vender muchos nichos, no pocos éxitos (Amazon).","<b>Peer-to-peer:</b> los usuarios son el activo (Uber, Airbnb)."])),
...
CLASES.append(dict(curso=IN, n=5, fecha="Sáb 24 oct 2026", titulo="Propuesta de valor + Customer Development",
  ...
  slides=[
   ...
   ("lista", dict(kicker="Lado de tu propuesta", h2="Products · Relievers · Creators", items=["<b>Products:</b> qué ofrecés.","<b>Pain relievers:</b> cómo quitás cada dolor.","<b>Gain creators:</b> cómo generás cada ganancia."])),
...
CLASES.append(dict(curso=IN, n=6, fecha="Sáb 07 nov 2026", titulo="Lean Startup + MVP",
  ...
  slides=[
   ...
   ("lista", dict(kicker="Tipos de MVP", h2="No hace falta código", items=["<b>Landing page:</b> medís interés antes de construir.","<b>Video:</b> mostrás cómo funcionaría (Dropbox).","<b>Concierge:</b> hacés el trabajo a mano (Zappos).","<b>Wizard of Oz:</b> el «software» es una persona detrás.","<b>Prototipo:</b> maqueta para testear usabilidad."])),
   ...
   ("lista", dict(kicker="La decisión", h2="Pivotar o perseverar", items=["<b>Perseverar:</b> la hipótesis se validó, seguí optimizando.","<b>Pivotar:</b> cambia un componente (segmento, canal, pricing) y re-testea.","Pivotar NO es fracasar: es aprender con datos."])),
...
CLASES.append(dict(curso=IN, n=7, fecha="Sáb 21 nov 2026", titulo="HITO · Presentá tu modelo disruptivo",
  ...
  slides=[
   ...
   ("lista", dict(kicker="Estructura", h2="Una buena presentación de 4 min", items=["<b>Problema</b> (el job no resuelto).","<b>Insight</b> (qué descubriste del cliente).","<b>Solución</b> (tu modelo).","<b>Pedido</b> (qué feedback buscás)."])),
